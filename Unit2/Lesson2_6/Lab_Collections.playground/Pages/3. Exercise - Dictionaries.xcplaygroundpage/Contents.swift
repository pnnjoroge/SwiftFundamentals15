 ...
 */
var myDictionary: [String: Int] = ["January": 31, "February": 28, "March": 31]
print(myDictionary)
...
if let value = myDictionary["January"] {
    print("January has \(value) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.

var shapesArray:[String : [String]] = ["Shapes": ["Circle", "Rectangle", "Oval"]]
var colorsArray: [String : [String]] = ["Colors": ["Red", "Yellow", "Green"]]
var anotherDictionary = [shapesArray, colorsArray]
...
let lastElement = Array(colorsArray.values)
print(lastElement[0][2])
/*:
