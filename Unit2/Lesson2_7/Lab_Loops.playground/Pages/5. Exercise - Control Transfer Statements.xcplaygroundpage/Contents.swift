...
var stateDictionary: [String: String] = ["North Carolina": "Raleigh", "California": "Sacramento", "Florida": "Tallahassee"]
var homeState: String = "North Carolina"
for (state, capital) in stateDictionary{
