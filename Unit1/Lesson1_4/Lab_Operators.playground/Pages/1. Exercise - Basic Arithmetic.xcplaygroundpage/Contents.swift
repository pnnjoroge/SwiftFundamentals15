...
print("This differs in the decimal points that the results have when the types are declared. The integers result is a whole number, while double type has a decimal point")
...
print(even)
print(odd)
print("To determine if an integer is even or odd using the results, I would look at if the remainder is 0. If it is 0, the integer is even. If it is more than 0, the integer is odd.")
/*:
